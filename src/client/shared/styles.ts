...
export const COMMENTS_CSS = [
  ...
  ".nb-comments h2{font-family:var(--font);font-size:1.25rem;font-weight:500;margin:0 0 1rem;}",
  ...
  ".nb-comments-closed{font-family:var(--font);font-style:italic;font-size:0.94rem;color:var(--muted);}",
